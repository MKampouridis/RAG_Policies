...
**Progress:** 91 of 94 resolved. Remaining: judge calibration (#40, in progress — scoring page at /calibration), the `rag.py` split (#77, ready but deferred), and real users / the paper (#93, #94).
